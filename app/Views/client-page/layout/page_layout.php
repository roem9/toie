...
<head>
  ...
  <link rel="icon" type="image/png" href="<?= base_url()?>/public/assets/logo-client/<?= $logo?>">
  <title>
    <?= $title ?>
  </title>
  <!--     Fonts and icons     -->
    ...
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 bg-white" id="sidenav-main" data-color="info">
      <div class="sidenav-header">
        ...
        <a class="navbar-brand m-0" href="/">
          <img src="<?= base_url()?>/public/assets/logo-client/<?= $logo?>" class="navbar-brand-img h-100" alt="main_logo">
        </a>
      </div>
      ...
      <div class="collapse navbar-collapse w-auto h-auto pb-0" id="sidenav-collapse-mai">
        <ul class="navbar-nav">
          <li class="nav-item">
            <a class="nav-link <?= ($sidebar == "tes") ? 'active' : '' ?>" href="<?= base_url('clientarea/tes') ?>">
          ...
          <li class="nav-item">
            <a class="nav-link <?= ($sidebar == "testoefl") ? 'active' : '' ?>" href="<?= base_url('clientarea/testoefl') ?>">
              <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-journal-text" viewBox="0 0 16 16">
                  <path d="M5 10.5a.5.5 0 0 1 .5-.5h2a.5.5 0 0 1 0 1h-2a.5.5 0 0 1-.5-.5zm0-2a.5.5 0 0 1 .5-.5h5a.5.5 0 0 1 0 1h-5a.5.5 0 0 1-.5-.5zm0-2a.5.5 0 0 1 .5-.5h5a.5.5 0 0 1 0 1h-5a.5.5 0 0 1-.5-.5zm0-2a.5.5 0 0 1 .5-.5h5a.5.5 0 0 1 0 1h-5a.5.5 0 0 1-.5-.5z"/>
                  <path d="M3 0h10a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H3a2 2 0 0 1-2-2v-1h1v1a1 1 0 0 0 1 1h10a1 1 0 0 0 1-1V2a1 1 0 0 0-1-1H3a1 1 0 0 0-1 1v1H1V2a2 2 0 0 1 2-2z"/>
    ...
    function logout() {
      Swal.fire({
        ...
        if (result.isConfirmed) {
          window.location = '<?= base_url()?>clientarea';
        }
      })
    }
